...
- stabilize simple geometric arrangements
...
**Mana shaping** is the deliberate use of volitional mana coupling to arrange Primed mana into constrained coherence arrangements that form or alter a mana construct scaffold. It is a specialized kind of mana casting, rather than a general synonym for all direct mana manipulation.
...
5. the completed geometry is stabilized long enough to receive its declaration

Mana shaping is therefore a sensorimotor discipline rather than an act of visualization. Mental images, gestures, breathing patterns, spoken mnemonics, and glyphs may assist concentration and sequencing, but they possess no inherent shaping power.
...
In casting terminology, **intent** is a trained volitional control state used to trigger or parameterize an already defined operation.
