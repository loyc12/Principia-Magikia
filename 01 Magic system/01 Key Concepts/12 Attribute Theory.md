...
Dimensional operation directly addresses a bounded region of space-time as its subject, rather than requiring a material subject or reagent. This increases its selection, bounding, anchoring, and regulation demands. Dimensional mana does not alter an object's intrinsic mass, create arbitrary topology, rewrite past events, or remove the need for declared boundaries. Scaling and curvature must account for stresses and discontinuities at the region's boundary. A portal requires prepared anchors and a structured coupling; distance modification alone does not grant unrestricted passage.
