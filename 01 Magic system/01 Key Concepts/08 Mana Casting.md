...
**Wild Casting**, also called **Instinctive Casting**, is casting performed through specialised evolved or innate anatomy rather than learned somaturgic practice or conscious formulaic construction. It is one category with two mechanical subtypes: **Wild Unstructured Casting** and **Wild Structured Casting**.
...
**Wild Structured Casting** is the rarer subtype in which specialised anatomy generates and executes a narrow spell assembly. The physical organisation of its organs and instinctive soul-form activity produce the required fixed scaffolds, declarations, and interfaces without symbolic notation or conscious construct reasoning.
...
Glyphs remain abstractions rather than sources of magical efficacy, and are distinct from the **pseudoglyphs** sometimes encountered in unstructured or reflexive casting by their highly standardised and analytical nature.
...
**Structured Casting** = writing, compiling, and executing a script or program whose operations can be composed, parameterised, repeated, and supervised.
