...
- **Spent** - carrying no bound potential, after that potential has been transferred elsewhere

Collectively, Primed, Spent, and the various Attuned mana attributes are known as **mana types**, and the process of converting from one of these to another is known as **mana permutation**. Each type occupies a distinct, discrete particle-potential level: Primed is the highest known state, Spent is the lowest, and every Attuned attribute lies at a different level between them. Permutation follows four ordinary processes and one exceptional process :
...
| **Priming**\*\* | Spent + potential returned through the [[The Singularity\|Singularity]] => Primed |

An attempted Attunement or Cross-Attunement is statistical at the particle scale. It either reaches the intended lower-potential type or **quenches** directly into Spent mana. Spent particles produced instead of the intended output are called **Waste mana**, while the proportion of attempts that quench is the **waste ratio**. A successful transition discharges the potential difference between its source and destination; quenching discharges the source particle's entire bound potential.

The released potential becomes a **permutation discharge**, which travels through the mana field as a **mana-field disruption**. Such disruptions alter local flow, transition conditions, and construct stability, and may trigger secondary downhill **counterreactions**. They are not destroyed: the curved mana field eventually carries them towards the Singularity.

*\*Detuning is passive loss of the original attribute. It never returns a particle to Primed mana.*

*\*\*Priming is the only established uphill permutation. It is known to occur only around the Singularity, which restores bound particle potential from the field potential returned to it.*

Mana particles are conserved through permutation. Potential is conserved across the combined physical and mana system: it may remain bound to a particle, enter or leave a physical subject through an attributed operation, travel as a mana-field disruption, or return to the Singularity. The matter and energy within a bounded physical system need not therefore conserve energy in isolation.

During Expenditure, operational transfer is signed. An operation may add energy or an equivalent physical change to its subject, leaving less potential to enter the mana field, or remove it from the subject, adding the removed amount to the field disruption. One particle cannot remove more than its own initial potential-equivalent, so cooling and comparable drainage remain proportional to the amount of Attuned mana expended. The detailed balance is defined in [[10 Mana Physics#Expenditure and Signed Operation|Mana Physics]].
...
They are also affected by the opposed influences of ordinary gravity and the curved mana field. Gravitational coupling increases with bound particle potential: Primed mana falls most strongly, the Attuned types display intermediate responses, and Spent mana has virtually no gravitational coupling. The mana-field gradient draws free disruptions and weakly coupled particles upwards towards the Singularity, so Spent mana rises while potential-bearing mana experiences a countervailing downward force. Local mana interference limits these motions to finite terminal velocities. The exact force profiles and gravitational response of each attribute remain open problems.
...
**Mana potential** is the type-dependent capacity carried by a mana particle. Primed potential is undifferentiated; an Attuned particle retains a smaller, quantised amount committed to its attribute's primitive operation; a Spent particle retains no bound potential. The potential difference released during permutation is distinct from the activation barrier that governs how readily that permutation begins. A deep potential drop may therefore remain rare if its barrier is difficult to cross.
...
Observed availability broadly suggests that scarcer attributes often require deeper potential drops and therefore release stronger permutation disturbances during formation. This tendency is not a complete ordering: activation barriers, seed behaviour, material affinity, and decay can make two attributes with similar potential levels differ greatly in abundance. The exact potential ladder remains unresolved.

An isolated Attuned particle does not normally possess enough stability bias or local concentration to remain Attuned. It usually Detunes into a lower-potential type, disperses, or becomes Spent before it can influence neighbouring Primed mana. An attempted Attunement also has a variable chance of quenching immediately into Spent mana rather than producing the intended Attuned particle. This portion is **Waste mana**. The resulting **waste ratio** depends upon the attribute, potential drop, activation barrier, stabilisation, process, and local conditions; wider or less controlled collection of fluctuations is generally less efficient.
...
**Cross-Attunement** is the controlled exploitation of fluctuations that may carry an already Attuned particle into a compatible lower-potential attribute. It requires a viable destination seed or other condition that stabilises the destination fluctuation long enough to cross its activation barrier. A successful transition discharges the intervening potential difference; a quenched transition produces Spent mana and discharges the entire source potential. Not every attribute pair permits a direct transition, and Cross-Attunement cannot reach a higher-potential attribute through ordinary practice. It may be useful when a lower attribute is required immediately, but is usually less efficient than preserving a dedicated supply.

Material conditions can capture, retain, or destabilise fluctuations and thereby support or suppress seeds. They do not select a new state by command or supply the differentiating potential. The classifications, mechanisms, and individual profiles for selective attunement and destabilising media are defined in [[13 Material Affinities|Material Affinities]].
...
The Singularity's distant influence on the mana-field may alter transition rates without directly raising a particle's potential. Observed Priming remains exclusive to the Singularity, while the wider field of the Expanse permits unstable differentiation to decay downhill in poorly maintained Attuned mana.
...
The availability grade summarises the combined effects of potential drop, activation barrier, background fluctuation, critical seed concentration, selective media, Detuning, and attainable conversion yield. It does not replace those measurements, determine an exact potential order, or remain uniform between regions.
