...
Mana is a particulate field governed by the [[01 Core Principles|core principles]] of source, transformation, and expenditure. Every particle is in one of three practical states:
...
A [[03 Soul-Forms|soul-form]] is a self-organising mana structure sustained by recurring neurological activity. In living beings it develops around nervous function and becomes a durable interface between body, mana, and perception. It can couple to mana, resist hostile change, and maintain a coherent internal boundary.

Soul-forms are not identical to minds, personalities, or consciousness. They enable a living being to use mana and preserve an organised pattern, but they do not by themselves grant thought or subjective experience. They may be injured, modified, preserved, transplanted, or derived only within the limits described in their dedicated reference.
...
[[05 Mana Constructs|Mana constructs]] are stable, mutually permeable arrangements of Primed mana that establish form, relation, logic, and persistence. They can carry information: constants, inputs, controls, references, retained state, and outputs. Their overlap can cause interference without making them solid barriers. Attuned mana provides the effect or work directed through that structure. A spell's concrete executable organisation is its **spell-form**, whether it consists of one construct or a wider assembly.
...
The principal casting practices, their methods, and their risks are collected in [[09 Casting Practices|Casting Practices]].
...
- A soul-form is a functional mana-organising boundary, not proof of a mind.
- Recurrent construct logic alone cannot form a soul-form; a qualifying physical neurological substrate is required.
- Complex or persistent magic requires durable organisation, maintenance, and a way to withstand interference.
- When specialised rules are needed, the topical documents take precedence over this overview.
