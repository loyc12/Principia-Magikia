...
[[05 Mana Constructs|Mana constructs]] are stable arrangements of Primed mana that establish form, relation, logic, and persistence. They can carry information: constants, inputs, controls, references, retained state, and outputs. Attuned mana provides the effect or work directed through that structure. A spell's concrete executable organisation is its **spell-form**, whether it consists of one construct or a wider assembly.
