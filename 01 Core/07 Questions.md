...
| -------- | ---------------------- | -------------------------------------------------------------------------------------------------------------- |
| 1        | Laws of magic          | Everything else depends on them.                                                                               |
| 2        | Ecology                | Determines what survival, agriculture, and settlement look like.                                               |
| 3        | Economy                | Explains why communities exist where they do and what people do every day.                                     |
| 4        | Social organization    | Families, guilds, villages, cities, and institutions emerge from the economy.                                  |
...
Magic immediately becomes part of ecology.
Maybe some plants literally require magical animals to reproduce.
Maybe magical predators maintain ecological balance.
...
Magic should change all four.

Example:

- If magical preservation exists, food markets change.
- If levitation exists, roads become less important.
